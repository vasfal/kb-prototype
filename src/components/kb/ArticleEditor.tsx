...
import { getRootCategories, contacts } from '@/data/mock-data';
...
export function ArticleEditor({ article, unitId, onSave, onClose }: ArticleEditorProps) {
  const isNew = !article;
        ...
        <div className="flex items-center justify-between px-6 py-2.5 border-b border-[#edeff3] shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-1.5">
              <span className="text-[13px] text-[#697a9b]">Category</span>
              <select
                value={folderId}
