...
import { getRootCategories, getChildFolders } from '@/data/mock-data';
    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-lg shadow-[0px_4px_12px_rgba(31,36,46,0.12)] w-[400px] overflow-hidden flex flex-col max-h-[70vh]">
        ...
        <div className="px-5 pt-5 pb-3 shrink-0">
          <h3 className="text-[16px] font-medium text-[#1f242e] leading-[24px]">Move article</h3>
          <p className="text-[13px] text-[#697a9b] mt-1">
            Select a category for "{article.title}"
          </p>
        </div>
